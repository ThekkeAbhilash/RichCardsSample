namespace CardsBot
{
    ...
    public class CardsDialog : IDialog<object>
    {
        ...
        public const string ReceiptCard = "Receipt card";
        public const string SigninCard = "Sign-in card";
        public const string AnimationCard = "Animation card";
        public const string VideoCard = "Video card";
        public const string AudioCard = "Audio card";

        public IEnumerable<string> options = new List<string> { HeroCard, ThumbnailCard, ReceiptCard, SigninCard, AnimationCard, VideoCard, AudioCard };
        ...
        public static Attachment GetSigninCard()
        {
        ...
        public static Attachment GetVideoCard()
        {
        ...
        public static Attachment GetAudioCard()
        {
